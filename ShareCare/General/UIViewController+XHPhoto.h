...
typedef void(^photosBlock)(NSArray *photos);

typedef enum : NSUInteger {
    SourceTypeCamera,
    SourceTypePhotoLibrary,
    SourceTypeCameraOrPhotoLibrary
} SourceType;
...
//- (void)showPhotoSourceType:(SourceType)sourceType canEdit:(BOOL)edit photo:(photoBlock)block;
...
-(void)showCanEdit:(BOOL)edit alerttitle:(NSString *)titleString photo:(photoBlock)block;
