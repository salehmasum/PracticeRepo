...
- (void)configCustomNaviBar {
    _naviBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.kf_width, 64+iSiPhoneX*24)];
    _naviBar.backgroundColor = [UIColor colorWithRed:(34/255.0) green:(34/255.0)  blue:(34/255.0) alpha:1.0];
    _naviBar.alpha = 0.7;
    _backButton = [[UIButton alloc] initWithFrame:CGRectMake(-40, 20+iSiPhoneX*24, 120, 44)];  
    [_backButton setImage:[UIImage imageNamed:@"back-button-white"] forState:UIControlStateNormal];
    [_backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_backButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    _displayLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.view.kf_width/2-25, 20+iSiPhoneX*24, 50, 44)];
    ...
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.kf_width - 80, 20+iSiPhoneX*24, 80, 44)];
    [_selectButton setTitle:@"Delete" forState:UIControlStateNormal];
...
- (void)select:(UIButton *)selectButton {
    UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Warning" message:@"Make sure you delete this picture？" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Confirm", nil];
    [alert show];
